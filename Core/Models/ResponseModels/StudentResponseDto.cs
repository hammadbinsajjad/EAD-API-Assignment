...
namespace Core.Models.ResponseModels
{
    ...
    public class StudentDetailSubjectResponseDto:StudentResponseDto
    {
        ...
        public StudentDetailSubjectResponseDto(int id, string name, string rollNo, string phoneNumber, List<StudentSubjectMarksDto> subjectMarks) : base(id, name, rollNo, phoneNumber)
        {
